...
namespace AutoGrad {
	...
	public:
		...
		Shape getShape() { return m_Value.getShape(); }
	...
	public:
		Placeholder(Shape &shape) : m_Shape(shape) { ; }
		virtual Shape getShape() { return m_Shape; }
	...
	public:
		...
		void run(map<Placeholder<T>*, Tensor<T>*> &feed_dict) {
			...
			//	operation->build(inputs[0].getShape());
			//}
